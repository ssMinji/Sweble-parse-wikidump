...
import src.job1.WikiLinksReducer;
import src.job1.WikiPageLinksMapper;
import src.job1.XmlInputFormat;
import src.job2.RankCalculateMapper;
import src.job2.RankCalculateReduce;
import src.job3.RankingMapper;
